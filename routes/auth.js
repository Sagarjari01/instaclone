...
const transporter = nodemailer.createTransport(sendGridTransport({
    auth:{
        api_key:"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"
    }
}))
// router.get('/',(req, res)=> {
//     res.send('hello')
...
//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
    ...
    .then(savedUser=>{
        ...
        .then(doMatch=>{
            if(doMatch){
                ...
                const token = jwt.sign({_id:savedUser._id},JWT_SECRET) // jwt.sign() to generate token 
